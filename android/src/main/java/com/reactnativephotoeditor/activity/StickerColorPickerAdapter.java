...
public class StickerColorPickerAdapter extends RecyclerView.Adapter<StickerColorPickerAdapter.ViewHolder> {
    ...
    StickerColorPickerAdapter(@NonNull Context context, @NonNull List<Integer> colorPickerColors) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.colorPickerColors = colorPickerColors;
    }

    StickerColorPickerAdapter(@NonNull Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.sticker_color_picker_item_list, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            colorPickerView = itemView.findViewById(R.id.sticker_color_picker_view);
